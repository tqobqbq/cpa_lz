...
func (e *AIStudioExecutor) Execute(ctx context.Context, auth *cliproxyauth.Auth, req cliproxyexecutor.Request, opts cliproxyexecutor.Options) (resp cliproxyexecutor.Response, err error) {
	...
	if _, errValidate := helps.ValidateDownstreamNonStreamPayloadWithOutputFilter(opts.SourceFormat, e.Identifier(), out, helps.OutputFilterFromConfig(e.cfg)); errValidate != nil {
		err = errValidate
		return resp, err
	}
