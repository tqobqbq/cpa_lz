				...
				case antigravity429DecisionFullQuotaExhausted:
					if usedCreditsDirect {
						...
						if creditsResp != nil {
							...
							if _, errValidate := helps.ValidateDownstreamNonStreamPayloadWithOutputFilter(from, e.Identifier(), converted, helps.OutputFilterFromConfig(e.cfg)); errValidate != nil {
								err = errValidate
								return resp, err
							}
