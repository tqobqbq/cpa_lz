...
const (
	...
	// RequestUserAgentMetadataKey stores the downstream request User-Agent header.
	RequestUserAgentMetadataKey = "request_user_agent"
	// RequestInputCharsMetadataKey stores the downstream request body character count.
	RequestInputCharsMetadataKey = "request_input_chars"
)
