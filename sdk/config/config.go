...
type OutputFilterRule = internalconfig.OutputFilterRule
type OutputFilterConfig = internalconfig.OutputFilterConfig
type ErrorControlConfig = internalconfig.ErrorControlConfig
type ErrorControlPolicy = internalconfig.ErrorControlPolicy
