...
import { AI_PROVIDER_EDIT_MODAL_ACTION_ROOT_ID } from '@/utils/aiProviderEditModal';
...
export const SecondaryScreenShell = forwardRef<HTMLDivElement, SecondaryScreenShellProps>(
  function SecondaryScreenShell(
    ...
    const modalActionRoot =
      typeof document === 'undefined'
        ? null
        : document.getElementById(AI_PROVIDER_EDIT_MODAL_ACTION_ROOT_ID);
        ...
        {shouldRenderFloatingAction && typeof document !== 'undefined'
          ? createPortal(
              <div
                className={
                  modalActionRoot
                    ? styles.floatingActionContainerInModal
