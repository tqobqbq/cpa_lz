...
export function VisualConfigEditor({
  ...
  const sections = useMemo<VisualSection[]>(
    ...
    [countErrors, hasPayloadValidationErrors, outputFilterErrorCount, t]
  );
          ...
          <div className={styles.sections}>
            ...
            >
              <SectionStack>
                ...
                <SectionGrid>
                  ...
                  <FieldAnchor fieldId="codexRemoveEmptyInputName">
                    <ToggleRow
                      title={t(
            ...
            >
              <SectionStack>
                ...
                >
                  <SectionGrid>
                    <FieldAnchor fieldId="outputFilterEnabled">
                      <ToggleRow
                        title={t('config_management.visual.sections.output_filter.enabled')}
                        description={t(
                          'config_management.visual.sections.output_filter.enabled_desc'
                        )}
