...
export const CONFIG_FIELD_SEARCH_INDEX: ConfigFieldSearchEntry[] = [
  ...
  {
    fieldId: 'codexRemoveEmptyInputName',
    sectionId: 'network',
    labelKey: L('sections.network.codex_remove_empty_input_name'),
    hintKey: L('sections.network.codex_remove_empty_input_name_desc'),
    yamlKeys: ['codex-remove-empty-input-name'],
    keywords: ['codex'],
  },
  {
  ...
  // ── outputFilter ────────────────────────────────────────────────────────────
  {
    fieldId: 'outputFilterEnabled',
    sectionId: 'outputFilter',
    labelKey: L('sections.output_filter.enabled'),
    hintKey: L('sections.output_filter.enabled_desc'),
    yamlKeys: ['output-filter'],
    keywords: ['filter', 'output'],
  },
