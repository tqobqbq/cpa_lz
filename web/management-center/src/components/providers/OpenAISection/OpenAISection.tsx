...
import {
  calculateStatusBarDataForOpenAIProvider,
  getOpenAIEntryKey,
...
export function OpenAISection({
  ...
  const statusBarCache = useMemo(() => {
    const cache = new Map<string, ReturnType<typeof calculateStatusBarDataForOpenAIProvider>>();
      ...
      >
        <ProviderList<OpenAIProviderConfig>
          ...
          renderContent={(item, index) => {
            ...
            const statusData = statusBarCache.get(getOpenAIProviderKey(item, index));
                    ...
                    <div className={styles.apiKeyEntryList}>
                      {apiKeyEntries.map((entry, entryIndex) => {
                        ...
                        return (
                          ...
                          >
                            <span className={styles.apiKeyEntryIndex}>{entryIndex}</span>
