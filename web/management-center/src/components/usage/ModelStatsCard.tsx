                ...
                <tbody>
                  {sorted.map((stat) => (
                    <tr key={stat.model}>
                      ...
                      <td>{stat.reasoningTokens.toLocaleString()}</td>
                      <td>{stat.cachedTokens.toLocaleString()}</td>
                      <td>{stat.cacheCreationTokens.toLocaleString()}</td>
                      <td>{stat.cacheReadTokens.toLocaleString()}</td>
