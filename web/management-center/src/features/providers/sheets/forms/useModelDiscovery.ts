...
export function useModelDiscovery(args: UseModelDiscoveryArgs): UseModelDiscoveryResult {
  const { brand, baseUrl, formHeaders, apiKeyEntries, apiKey, fallbackApiKey, authIndex, authMode } =
    args;
  ...
  }, [available, apiKey, apiKeyEntries, authIndex, authMode, baseUrl, brand, fallbackApiKey, formHeaders]);
