...
export function UsagePage() {
  ...
  const filteredDetailsUsage = useMemo(
    () => (usage ? filterUsageDetailsByTimeRange(usage, timeRange) : null),
    [usage, timeRange]
  );
  ...
  const apiStats = useMemo(
    () => getApiStats(filteredDetailsUsage, modelPrices),
    [filteredDetailsUsage, modelPrices]
  );
