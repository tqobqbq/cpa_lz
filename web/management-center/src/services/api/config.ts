...
export const configApi = {
   ...
   */
  updateCodexRemoveEmptyInputName: (enabled: boolean) =>
    apiClient.put('/codex-remove-empty-input-name', { value: enabled }),
   ...
   * 更新路由规则
   */
  updateRoutingRules: (rules: unknown[]) => apiClient.put('/routing/rules', rules),
};
