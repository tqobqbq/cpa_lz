  ...
  setDraftTestModel: (key, action) => {
    ...
    set((state) => {
      ...
      return {
        drafts: {
          ...state.drafts,
          [key]: { ...existing, initialized: existing.initialized, testModel: nextValue },
        },
      };
    });
  },
  ...
  setDraftTestStatus: (key, action) => {
    ...
    set((state) => {
      ...
      return {
        drafts: {
          ...state.drafts,
          [key]: { ...existing, initialized: existing.initialized, testStatus: nextValue },
        },
      };
    });
  },
  ...
  setDraftTestMessage: (key, action) => {
    ...
    set((state) => {
      ...
      return {
        drafts: {
          ...state.drafts,
          [key]: { ...existing, initialized: existing.initialized, testMessage: nextValue },
        },
      };
    });
  },
